...
use sunnnnn\wechat\pay\lib\NativePay;
...
// 	}
	...
	* @author: sunnnnn [www.sunnnnn.com] [mrsunnnnn@qq.com]
	 */
	public function native($productId, $onlyData = false){
	...
	* @return Ambigous <string, \sunnnnn\wechat\pay\lib\成功时返回，其他抛异常>
	 */
	public function nativeWithNotify($order, $onlyData = false){
	...
	* @author: sunnnnn [www.sunnnnn.com] [mrsunnnnn@qq.com]
	* @param unknown $callback 业务回调函数，成功返回true，失败返回错误msg
